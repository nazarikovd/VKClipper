...
![image](https://github.com/user-attachments/assets/e1e302ad-abf2-4295-9833-7df833eccbd5)
<img width="408" height="925" alt="image" src="https://github.com/user-attachments/assets/a9d6742c-7a4b-4b06-a689-924351e85b41" />
<img width="408" height="925" alt="image" src="https://github.com/user-attachments/assets/dbfd7455-0ba5-4f95-b845-08599d729f0c" />
![image](https://github.com/user-attachments/assets/f74a999e-679d-4721-b92d-d42506cfbb2a)
...
**Просто Zапуск:**
0. Скачать репо в папку clipper
1. Поменять url в конце файла (при необходимости) [ClipperApp/src/Components/API.js](https://github.com/nazarikovd/VKClipper/blob/main/ClipperApp/src/Components/API.js)
```javascript
...
4. Собрать бек и запустить
```bash
npm install
node server.js
```
5. Если не собралось подумать и исправить проблемы
